            ...
            using (var conn = Connection)
            {
                ...
                using (var cmd = conn.CreateCommand())
                {
                    ...
                    while (reader.Read())
                    {
                        posts.Add(new Post()
                        {
                            //'DbUtils' is a class we created in order to help simplify some of our database interaction code, 
                            //particularly with regards to dealing with null values like some of the captions in Post
